...
st.title("Audio Input in Streamlit")

# Function to capture audio
def record_audio():
    audio_data = sd.rec(5 * 44100, samplerate=44100, channels=1, dtype=np.int16)
    sd.wait()
    return audio_data
...
st.text("Press the 'Start Recording' button to begin recording audio.")
